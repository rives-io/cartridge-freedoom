...
/* Compile hash: V9u7pLMBL2dta1pFBZtXHo5gv1S */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
static NELUA_INLINE nelua_span_string_ nelua_span_string____convert_1(nelua_sequence_string__1 values);
typedef struct nlmulret_nlboolean_nlint64_nlstring {
  bool r1;
  int64_t r2;
  nlstring r3;
} nlmulret_nlboolean_nlint64_nlstring;
typedef nlmulret_nlboolean_nlint64_nlstring (*function_3QYqT8LKmL6RBAgu6)(nelua_sequence_string__1, int64_t);
typedef struct nlmulret_function_3QYqT8LKmL6RBAgu6_nelua_sequence_string__1_nlint64 {
  function_3QYqT8LKmL6RBAgu6 r1;
  nelua_sequence_string__1 r2;
  int64_t r3;
} nlmulret_function_3QYqT8LKmL6RBAgu6_nelua_sequence_string__1_nlint64;
static NELUA_INLINE nlmulret_function_3QYqT8LKmL6RBAgu6_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a);
...
typedef int (*function_4eJYrqGJCd3LbqUMB)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_4eJYrqGJCd3LbqUMB closef;
};
...
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_3(nelua_stringbuilderT_ptr self, nlstring fmt, uint64_t __arg1);
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_4(nelua_stringbuilderT_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4);
...
static nlstring nelua_nlstring_concat_1(nelua_span_string_ list, nlstring sep);
...
typedef int (*function_5DEpTdhkpKhVQGDuB)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_5DEpTdhkpKhVQGDuB closef);
...
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_2(nelua_filestream_ptr self, nlstring fmt, uint64_t __arg1);
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_3(nelua_filestream_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4);
static void nelua_filestream_printf_1(nelua_filestream_ptr self, nlstring __arg1);
static void nelua_filestream_printf_2(nelua_filestream_ptr self, nlstring __arg1, uint64_t __arg2);
static void nelua_filestream_printf_3(nelua_filestream_ptr self, nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5);
...
static void nelua_io_printf_2(nlstring __arg1, uint64_t __arg2);
static void nelua_io_printf_3(nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5);
...
typedef uint32_t deps_fs_fs_StatKind;
static deps_fs_fs_StatKind deps_fs_kind_from_mode(unsigned int mode);
typedef struct deps_fs_fs_StatInfo deps_fs_fs_StatInfo;
struct deps_fs_fs_StatInfo {
  deps_fs_fs_StatKind kind;
  uint64_t dev;
  uint64_t ino;
  uint64_t nlink;
  uint32_t mode;
...
typedef struct nlmulret_deps_fs_fs_StatInfo_nlstring_nlint64 {
  deps_fs_fs_StatInfo r1;
  nlstring r2;
  int64_t r3;
} nlmulret_deps_fs_fs_StatInfo_nlstring_nlint64;
static nlmulret_deps_fs_fs_StatInfo_nlstring_nlint64 deps_fs_fs_stat_1(nlstring path, nlniltype linkstat);
...
static nlstring fbdoom_machine_fbdoom_machine_bootargs;
static char nelua_strlit_1[173] = "console=hvc0 rootfstype=ext2 root=/dev/mtdblock0 rw quiet swiotlb=noforce mtdparts=flash.0:-(root) hugepagesz=2M hugepages=1 -- /root/fbdoom -iwad /root/doom1.wad -nomusic ";
static bool fbdoom_machine_fbdoom_machine_debug_fps = false;
static bool fbdoom_machine_fbdoom_machine_statdump = false;
static int64_t fbdoom_machine_fbdoom_machine_rootfs_length;
...
typedef struct NELUA_MAYALIAS nluint8_arr2097152 {uint8_t v[2097152];} nluint8_arr2097152;
typedef union NELUA_MAYALIAS nluint8_arr2097152_cast {nluint8_arr2097152 a; uint8_t p[2097152];} nluint8_arr2097152_cast;
static nluint8_arr2097152 fbdoom_machine_fbdoom_machine_machine_output;
...
static bool fbdoom_machine_fbdoom_machine_halted;
static void fbdoom_machine_fbdoom_machine_machine_poll(void);
static nelua_filestream nelua_assert_msg_nelua_filestream(nelua_filestream cond, nlstring msg);
static void nelua_print_1(nlstring a1);
static double fbdoom_machine_fbdoom_machine_time_elapsed_sum = 0.0;
static uint64_t fbdoom_machine_fbdoom_machine_mcycle_elapsed_sum = 0U;
static uint64_t fbdoom_machine_fbdoom_machine_fps;
static double fbdoom_machine_fbdoom_machine_last_time = 0.0;
...
static sapp_desc fbdoom_machine_fbdoom_machine_app_desc = {.init_cb = fbdoom_machine_fbdoom_machine_init, .frame_cb = fbdoom_machine_fbdoom_machine_frame, .cleanup_cb = fbdoom_machine_fbdoom_machine_cleanup, .event_cb = fbdoom_machine_fbdoom_machine_event, .width = 320, .height = 240, .window_title = (char*)"DOOM"};
...
nelua_span_string_ nelua_span_string____convert_1(nelua_sequence_string__1 values) {
  nelua_span_string_ self = (nelua_span_string_){0};
  if((nelua_sequence_string__1___len((&values)) > 0)) {
    self.data = ((nlstring_arr0_ptr)(&(*nelua_sequence_string__1___atindex((&values), 1U))));
    self.size = (uintptr_t)nelua_sequence_string__1___len((&values));
  }
  return self;
}
nlmulret_nlboolean_nlint64_nlstring nelua_ipairs_next(nelua_sequence_string__1 a_1, int64_t k) {
  ...
  _mulret_1.r1 = true;
  _mulret_1.r2 = k;
  _mulret_1.r3 = (*nelua_sequence_string__1___atindex((&a_1), (uintptr_t)k));
  return _mulret_1;
}
nlmulret_function_3QYqT8LKmL6RBAgu6_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a) {
  return (nlmulret_function_3QYqT8LKmL6RBAgu6_nelua_sequence_string__1_nlint64){nelua_ipairs_next, a, 0};
}
...
nelua_FStream_ptr nelua_GeneralAllocator_new_2(nelua_GeneralAllocator_ptr self, nelua_FStream what, nlniltype size, nlniltype flags) {
  nelua_FStream_ptr ptr = ((nelua_FStream_ptr)nelua_GeneralAllocator_xalloc_1(self, 16U, NELUA_NIL));
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_3(nelua_stringbuilderT_ptr self, nlstring fmt, uint64_t __arg1) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_4(nelua_stringbuilderT_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
...
nlstring nelua_nlstring_concat_1(nelua_span_string_ list, nlstring sep) {
  uintptr_t size = 0U;
  ...
  for(uintptr_t i = 0U, _end = list.size; i < _end; i += 1) {
    if(((sep.size > 0) && (i > 0))) {
      for(uintptr_t j = 0U, _end = sep.size; j < _end; j += 1) {
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_5DEpTdhkpKhVQGDuB closef) {
...
nlmulret_nelua_filestream_nlstring_nlint64 nelua_filestream_open_1(nlstring filename, nlstring mode) {
  nelua_assert_msg_nlvoid(nelua_checkmode(mode), ((nlstring){(uint8_t*)"invalid mode", 12}));
  FILE_ptr fp = fopen(nelua_string2cstring(filename), nelua_string2cstring(mode));
  if((!(fp != NULL))) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  nelua_FStream_ptr fs_1 = self->fs;
  if(((!(fs_1 != NULL)) || (!(fs_1->fp != NULL)))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
  if((((fs_1->fp == stdout) || (fs_1->fp == stderr)) || (fs_1->fp == stdin))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"cannot close standard file", 26}), -1};
  }
  int res = 0;
  if((fs_1->closef != NULL)) {
    res = fs_1->closef(fs_1->fp);
  }
  self->fs->fp = ((FILE_ptr)NULL);
  self->fs->closef = (function_4eJYrqGJCd3LbqUMB)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno();
    return (nlmulret_nlboolean_nlstring_nlint64){false, _ret_1.r1, _ret_1.r2};
  }
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_2(nelua_filestream_ptr self, nlstring fmt, uint64_t __arg1) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_3(nelua_filestream_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
...
void nelua_filestream_printf_2(nelua_filestream_ptr self, nlstring __arg1, uint64_t __arg2) {
  nelua_filestream_writef_2(self, __arg1, __arg2);
  nelua_filestream_flush(self);
}
void nelua_filestream_printf_3(nelua_filestream_ptr self, nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5) {
  nelua_filestream_writef_3(self, __arg1, __arg2, __arg3, __arg4, __arg5);
  nelua_filestream_flush(self);
}
...
void nelua_io_printf_2(nlstring __arg1, uint64_t __arg2) {
  nelua_filestream_printf_2((&nelua_io_stdout), __arg1, __arg2);
}
void nelua_io_printf_3(nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5) {
  nelua_filestream_printf_3((&nelua_io_stdout), __arg1, __arg2, __arg3, __arg4, __arg5);
}
...
deps_fs_fs_StatKind deps_fs_kind_from_mode(unsigned int mode) {
  if(S_ISREG(mode)) {
    return 1U;
...
nlmulret_deps_fs_fs_StatInfo_nlstring_nlint64 deps_fs_fs_stat_1(nlstring path, nlniltype linkstat) {
  ...
  if((res != 0)) {
    return (nlmulret_deps_fs_fs_StatInfo_nlstring_nlint64){(deps_fs_fs_StatInfo){0}, nelua_cstring2string(strerror(errno)), (int64_t)errno};
  }
  deps_fs_fs_StatInfo si = (deps_fs_fs_StatInfo){.kind = deps_fs_kind_from_mode(st.st_mode), .dev = (uint64_t)st.st_dev, .ino = (uint64_t)st.st_ino, .nlink = (uint64_t)st.st_nlink, .mode = (uint32_t)st.st_mode, .uid = (uint32_t)st.st_uid, .gid = (uint32_t)st.st_gid, .rdev = (uint64_t)st.st_rdev, .size = (int64_t)st.st_size, .atime = st.st_atime, .mtime = st.st_mtime, .ctime = st.st_ctime};
  si.blksize = (int64_t)st.st_blksize;
  si.blocks = (int64_t)st.st_blocks;
  return (nlmulret_deps_fs_fs_StatInfo_nlstring_nlint64){si, (nlstring){0}, 0};
}
...
nelua_filestream nelua_assert_msg_nelua_filestream(nelua_filestream cond, nlstring msg) {
  if(NELUA_UNLIKELY(!true)) {
    nelua_write_stderr((const char*)msg.data, msg.size, true);
    nelua_abort();
  }
  return cond;
...
void fbdoom_machine_fbdoom_machine_machine_poll(void) {
  while(true) {
    ...
    if((break_reason == 1)) {
      fbdoom_machine_fbdoom_machine_halted = true;
      nelua_io_printf_1(((nlstring){(uint8_t*)"Halted\n", 7}));
      nelua_io_printf_2(((nlstring){(uint8_t*)"Cycles: %d\n", 11}), cartesi_utils_CartesiMachine_read_mcycle((&fbdoom_machine_fbdoom_machine_machine)));
      cartesi_utils_CartesiMachine_read_memory((&fbdoom_machine_fbdoom_machine_machine), 40532396646334464ULL, (nelua_span_uint8_){.data = ((nluint8_arr0_ptr)(&fbdoom_machine_fbdoom_machine_machine_output)), .size = 2097152U});
      nlstring output = nelua_cstring2string((char*)(&fbdoom_machine_fbdoom_machine_machine_output.v[0]));
      sapp_quit();
      if(fbdoom_machine_fbdoom_machine_statdump) {
        nelua_filestream output_file = ({
          nlmulret_nelua_filestream_nlstring_nlint64 _tmp1 = nelua_io_open_1(((nlstring){(uint8_t*)"machine_output.txt", 18}), ((nlstring){(uint8_t*)"w", 1}));
          nelua_assert_msg_nelua_filestream(_tmp1.r1, _tmp1.r2);
        });
        {
          nlmulret_nlboolean_nlstring_nlint64 _tmp1 = nelua_filestream_write_1((&output_file), output);
          nelua_assert_msg_nlvoid(_tmp1.r1, _tmp1.r2);
        }
        nelua_filestream_close((&output_file));
        nelua_print_1(((nlstring){(uint8_t*)"==== MACHINE OUTPUT ====", 24}));
        nelua_print_1(output);
      }
      return;
    } else if((break_reason != 3)) {
      nelua_io_printf_1(((nlstring){(uint8_t*)"unexpected break reason\n", 24}));
      sapp_quit();
      return;
    }
...
void fbdoom_machine_fbdoom_machine_machine_frame_poll(void) {
  ...
  fbdoom_machine_fbdoom_machine_fps = (fbdoom_machine_fbdoom_machine_fps + 1);
  fbdoom_machine_fbdoom_machine_time_elapsed_sum = (fbdoom_machine_fbdoom_machine_time_elapsed_sum + (time_end - time_start));
  fbdoom_machine_fbdoom_machine_mcycle_elapsed_sum = (fbdoom_machine_fbdoom_machine_mcycle_elapsed_sum + (mcycle_end - mcycle_start));
  double last_time_elapsed = (time_end - fbdoom_machine_fbdoom_machine_last_time);
  if((last_time_elapsed >= 1.0)) {
    if((fbdoom_machine_fbdoom_machine_debug_fps && (!fbdoom_machine_fbdoom_machine_halted))) {
      double mips = (fbdoom_machine_fbdoom_machine_mcycle_elapsed_sum / (fbdoom_machine_fbdoom_machine_time_elapsed_sum * 1000000.0));
      double cpu_usage = ((fbdoom_machine_fbdoom_machine_time_elapsed_sum * 100.0) / last_time_elapsed);
      nelua_io_printf_3(((nlstring){(uint8_t*)"frame=%d fps=%.2f guest_cpu_clock=%.2fMHz host_cpu_usage=%.2f%%\n", 64}), fbdoom_machine_fbdoom_machine_frame_count, (fbdoom_machine_fbdoom_machine_fps / last_time_elapsed), mips, cpu_usage);
    }
    fbdoom_machine_fbdoom_machine_fps = 0U;
    fbdoom_machine_fbdoom_machine_last_time = time_end;
    fbdoom_machine_fbdoom_machine_time_elapsed_sum = 0.0;
    fbdoom_machine_fbdoom_machine_mcycle_elapsed_sum = 0U;
  }
...
int nelua_main(int argc, char** argv) {
  ...
  fbdoom_machine_fbdoom_machine_bootargs = nelua_nlstring___concat_2(((nlstring){(uint8_t*)nelua_strlit_1, 172}), nelua_nlstring_concat_1(nelua_span_string____convert_1(nelua_arg), ((nlstring){(uint8_t*)" ", 1})));
  {
    nlmulret_function_3QYqT8LKmL6RBAgu6_nelua_sequence_string__1_nlint64 _asgnret_1 = nelua_ipairs_1(nelua_arg);
    function_3QYqT8LKmL6RBAgu6 __fornext = _asgnret_1.r1;
    ...
    while(true) {
      ...
      __fornextit = i;
      {
        if(nelua_nlstring___eq(arg_1, ((nlstring){(uint8_t*)"-debug-fps", 10}))) {
          fbdoom_machine_fbdoom_machine_debug_fps = true;
        }
        if(nelua_nlstring___eq(arg_1, ((nlstring){(uint8_t*)"-statdump", 9}))) {
          fbdoom_machine_fbdoom_machine_statdump = true;
        }
      }
    }
  }
  fbdoom_machine_fbdoom_machine_rootfs_length = deps_fs_fs_stat_1(((nlstring){(uint8_t*)"./images/fbdoom_rootfs.ext2", 27}), NELUA_NIL).r1.size;
  if((fbdoom_machine_fbdoom_machine_rootfs_length == 0)) {
    nelua_panic_string(((nlstring){(uint8_t*)"fbdoom_rootfs.ext2 not found", 28}));
  }
  fbdoom_machine_fbdoom_machine_machine = cartesi_utils_CartesiMachine_create((cm_machine_config){.ram = {.image_filename = (char*)"./images/linux-hugetlbfs-5.15.63-ctsi-1.bin", .length = 134217728U}, .rom = {.image_filename = (char*)"./images/rom-v0.15.0.bin", .bootargs = nelua_string2cstring(fbdoom_machine_fbdoom_machine_bootargs)}, .htif = {.yield_automatic = true}, .flash_drive = {.count = 2U, .entry = NELUA_LITERAL_REF(cm_memory_range_config_arr8, ((cm_memory_range_config_arr8){{{.start = 0x80000000000000ULL, .length = (uint64_t)deps_fs_fs_stat_1(((nlstring){(uint8_t*)"./images/fbdoom_rootfs.ext2", 27}), NELUA_NIL).r1.size, .image_filename = (char*)"./images/fbdoom_rootfs.ext2"}, {.start = 40532396646334464ULL, .length = 2097152U}}}))}});
