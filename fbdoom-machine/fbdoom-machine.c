...
/* Compile hash: 47GAsbeneY6wF1u6nA5pCK6xNNMK */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef int (*function_2TJKA7k5QQzpooW5o)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_2TJKA7k5QQzpooW5o closef;
};
...
typedef int (*function_3X6vFVrS2Reo3A72y)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_3X6vFVrS2Reo3A72y closef);
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_3X6vFVrS2Reo3A72y closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_2TJKA7k5QQzpooW5o)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno();
    return (nlmulret_nlboolean_nlstring_nlint64){false, _ret_1.r1, _ret_1.r2};
  }
