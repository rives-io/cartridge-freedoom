...
/* Compile hash: 2EakxNWVxRGT275RdNJL7UdtAUGG */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef nlmulret_nlboolean_nlint64_nlstring (*function_3s6DRjWRq1FZoenAL)(nelua_sequence_string__1, int64_t);
typedef struct nlmulret_function_3s6DRjWRq1FZoenAL_nelua_sequence_string__1_nlint64 {
  function_3s6DRjWRq1FZoenAL r1;
  nelua_sequence_string__1 r2;
  int64_t r3;
} nlmulret_function_3s6DRjWRq1FZoenAL_nelua_sequence_string__1_nlint64;
static NELUA_INLINE nlmulret_function_3s6DRjWRq1FZoenAL_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a);
...
typedef int (*function_57r5HCxN69VdamKJZ)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_57r5HCxN69VdamKJZ closef;
};
...
static nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_3(nelua_stringbuilderT_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4);
...
typedef int (*function_43RVdKVxZbU5rCR8K)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_43RVdKVxZbU5rCR8K closef);
...
static nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_2(nelua_filestream_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4);
static void nelua_filestream_printf_1(nelua_filestream_ptr self, nlstring __arg1);
static void nelua_filestream_printf_2(nelua_filestream_ptr self, nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5);
...
static void nelua_io_printf_2(nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5);
...
nlmulret_function_3s6DRjWRq1FZoenAL_nelua_sequence_string__1_nlint64 nelua_ipairs_1(nelua_sequence_string__1 a) {
  return (nlmulret_function_3s6DRjWRq1FZoenAL_nelua_sequence_string__1_nlint64){nelua_ipairs_next, a, 0};
}
...
nlmulret_nlboolean_nlusize nelua_stringbuilderT_writef_3(nelua_stringbuilderT_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4) {
  uintptr_t pos = 0U;
  uintptr_t written = 0U;
  int32_t argi = 0;
  while((pos < fmt.size)) {
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_43RVdKVxZbU5rCR8K closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_57r5HCxN69VdamKJZ)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno();
    return (nlmulret_nlboolean_nlstring_nlint64){false, _ret_1.r1, _ret_1.r2};
  }
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_writef_2(nelua_filestream_ptr self, nlstring fmt, uint64_t __arg1, double __arg2, double __arg3, double __arg4) {
  FILE_ptr fp = nelua_filestream__getfp(self);
  if((!(fp != NULL))) {
    return (nlmulret_nlboolean_nlstring_nlint64){false, ((nlstring){(uint8_t*)"attempt to use a closed file", 28}), -1};
  }
  nelua_stringbuilderT sb = (nelua_stringbuilderT){0};
  if((!nelua_stringbuilderT_writef_3((&sb), fmt, __arg1, __arg2, __arg3, __arg4).r1)) {
    nlmulret_nlboolean_nlstring_nlint64 _mulret_1;
    _mulret_1.r1 = false;
    _mulret_1.r2 = ((nlstring){(uint8_t*)"not enough memory", 17});
    _mulret_1.r3 = 0;
...
void nelua_filestream_printf_2(nelua_filestream_ptr self, nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5) {
...
void nelua_io_printf_2(nlstring __arg1, uint64_t __arg2, double __arg3, double __arg4, double __arg5) {
  nelua_filestream_printf_2((&nelua_io_stdout), __arg1, __arg2, __arg3, __arg4, __arg5);
}
...
void fbdoom_machine_fbdoom_machine_machine_poll(void) {
  while(true) {
    ...
    if((break_reason == 1)) {
      ...
      sapp_quit();
      nelua_print_1(((nlstring){(uint8_t*)"Machine OUTPUT saved to file machine_output.txt", 47}));
...
void fbdoom_machine_fbdoom_machine_machine_frame_poll(void) {
  ...
  if((last_time_elapsed >= 1.0)) {
    if(fbdoom_machine_fbdoom_machine_debug_fps) {
...
int nelua_main(int argc, char** argv) {
  ...
  {
    nlmulret_function_3s6DRjWRq1FZoenAL_nelua_sequence_string__1_nlint64 _asgnret_1 = nelua_ipairs_1(nelua_arg);
    function_3s6DRjWRq1FZoenAL __fornext = _asgnret_1.r1;
