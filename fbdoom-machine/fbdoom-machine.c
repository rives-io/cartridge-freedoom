...
/* Compile hash: 4MAo12TtMqr3TTRM6Stwnk4bsFDY */
/* ------------------------------ DIRECTIVES -------------------------------- */
...
typedef int (*function_3mSyBPfgKhJAQtc7n)(FILE_ptr);
struct nelua_FStream {
  FILE_ptr fp;
  function_3mSyBPfgKhJAQtc7n closef;
};
...
typedef int (*function_3c8GVe9MbESUfoPPv)(FILE_ptr);
static nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_3c8GVe9MbESUfoPPv closef);
...
nelua_filestream nelua_filestream__fromfp(FILE_ptr fp, function_3c8GVe9MbESUfoPPv closef) {
...
nlmulret_nlboolean_nlstring_nlint64 nelua_filestream_close(nelua_filestream_ptr self) {
  ...
  self->fs->closef = (function_3mSyBPfgKhJAQtc7n)NULL;
  if((res != 0)) {
    nlmulret_nlstring_nlint64 _ret_1 = nelua_geterrno();
    return (nlmulret_nlboolean_nlstring_nlint64){false, _ret_1.r1, _ret_1.r2};
  }
