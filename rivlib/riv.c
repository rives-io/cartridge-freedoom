...
/* Compile command: riscv64-linux-gnu-gcc -x c "rivlib/riv.c" -x none -fwrapv -fno-strict-aliasing -O2 -DNDEBUG -o "rivlib/riv" */
/* Compile hash: SmGKAshSFkGoSsSKNJUXt1ggQaM */
/* ------------------------------ DIRECTIVES -------------------------------- */
